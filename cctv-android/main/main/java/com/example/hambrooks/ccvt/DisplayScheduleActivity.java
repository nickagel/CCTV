...
//                    R.layout.list_schedules, new String[]{"name", "email",
...
public class DisplayScheduleActivity extends AppCompatActivity {
    ...
    public void sendTo117(View view) {
        // Do something in response to button
        Intent intent = new Intent(this, Display117Schedule.class);
        startActivity(intent);
    }

    public void sendTo317(View view) {
        // Do something in response to button
        Intent intent = new Intent(this, Display317Schedule.class);
        startActivity(intent);
    }
}
